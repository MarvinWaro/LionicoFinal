                ...
                <div class="add-form-container">
                    <form class="add-form" action="editfaculty.php" method="post">
                        ...
                        <select name="rank" id="rank">
                            <option value="None" <?php if(isset($_POST['rank'])) { if ($_POST['rank'] == 'None') echo ' selected="selected"'; } elseif ($data['academic_rank'] == 'None') echo ' selected="selected"'; ?>>--Select--</option>
                            <option value="Instructor" <?php if(isset($_POST['rank'])) { if ($_POST['rank'] == 'Instructor') echo ' selected="selected"'; } elseif ($data['academic_rank'] == 'Instructor') echo ' selected="selected"'; ?>>Instructor</option>
                            <option value="Asst. Professor" <?php if(isset($_POST['rank'])) { if ($_POST['rank'] == 'Asst. Professor') echo ' selected="selected"'; } elseif ($data['academic_rank'] == 'Asst. Professor') echo ' selected="selected"'; ?>>Asst. Professor</option>
                            <option value="Asso. Professor" <?php if(isset($_POST['rank'])) { if ($_POST['rank'] == 'Asso. Professor') echo ' selected="selected"'; } elseif ($data['academic_rank'] == 'Asso. Professor') echo ' selected="selected"'; ?>>Asso. Professor</option>
                            <option value="Professor" <?php if(isset($_POST['rank'])) { if ($_POST['rank'] == 'Professor') echo ' selected="selected"'; } elseif ($data['academic_rank'] == 'Professor') echo ' selected="selected"'; ?>>Professor</option>
                        </select>
                        <?php
                        ...
                        <select name="department" id="department">
                            <option value="None" <?php if(isset($_POST['department'])) { if ($_POST['department'] == 'None') echo ' selected="selected"'; } elseif ($data['department'] == 'None') echo ' selected="selected"'; ?>>--Select--</option>
                            ...
                            <option value="Information Technology" <?php if(isset($_POST['department'])) { if ($_POST['department'] == 'Information Technology') echo ' selected="selected"'; } elseif ($data['department']  == 'Information Technology') echo ' selected="selected"'; ?>>Information Technology</option>
                        </select>
                        <?php
                        ...
                        <div>
                            ...
                            <label class="container" for="admin">Admission Officer
                                <input type="radio" name="role" id="admin" value="Admission Officer" <?php if(isset($_POST['role'])) { if ($_POST['role'] == 'Admission Officer') echo ' checked'; } elseif ($data['admission_role'] == 'Admission Officer') echo ' checked'; ?>>
                                <span class="checkmark"></span>
                            </label>
                            <label class="container" for="interviewer">Interviewer
                                <input type="radio" name="role" id="interviewer" value="Interviewer" <?php if(isset($_POST['role'])) { if ($_POST['role'] == 'Interviewer') echo ' checked'; } elseif ($data['admission_role'] == 'Interviewer') echo ' checked'; ?>>
                                <span class="checkmark"></span>
                            </label>
